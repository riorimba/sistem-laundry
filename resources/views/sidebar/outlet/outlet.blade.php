...
<div class="section-header">
  ...
  <div class="section-header-breadcrumb">
    ...
    <div class="breadcrumb-item"><a href="{{route ('show-outlet')}}">Outlet</a></div>
  ...
  <div class="section-body">
      <div class="row">
          <div class="col-12 col-md-12 col-lg-12">
              <a href="{{route ('add-outlet')}}" class="btn btn-icon icon-left btn-primary"><i class="far fa-edit"></i> Tambah Data</a>
              <hr>
              {{-- message simpan data --}}
              ...
              <table class="table table-striped table-bordered">
                ...
                <tr>
                  ...
                  <td>
                    <form action="{{route('delete-outlet',$data->id)}}" id="hapus{{$data->id}}"method="POST">
                      @csrf
                      @method('delete')
                      <a href="{{route('edit-outlet',  Crypt::encryptString($data->id))}}" class="btn btn-icon btn-primary"><i class="far fa-edit"></i></a>
